...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const mockApiUrl = "https://run.mocky.io/v3/9c076903-f80e-4b19-94ee-31031e94a46f"; // Mock.io API URL
    ...
    fetch(mockApiUrl)
        ...
        // Sol reklamın kapatma butonu için olay dinleyicisi
        const leftCloseButton = leftAd.querySelector(".close-ad");
        leftCloseButton.addEventListener("click", () => {
        leftAd.style.display = "none"; // Sol reklamı gizle
        });

        // Sağ reklamın kapatma butonu için olay dinleyicisi
        const rightCloseButton = rightAd.querySelector(".close-ad");
        rightCloseButton.addEventListener("click", () => {
        rightAd.style.display = "none"; // Sağ reklamı gizle
        });
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", (e) => {
        e.preventDefault(); // Sayfanın varsayılan yenilenmesini durdur
        ...
        // Tüm kontroller geçti, yönlendir
